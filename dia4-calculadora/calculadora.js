...
const inserirDecimal = () => {
  if (!existeDecimal()){
    if (existeValor()){ atualizarDisplay(',');
...
const maparTeclado = (evento) => {
  ...
  const teclaPerminitda = () => Object.keys(mapaTeclado).indexOf(tecla) !== -1;
  if (teclaPerminitda()) document.getElementById(mapaTeclado[tecla]).click();
}
